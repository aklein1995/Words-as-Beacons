...
class RoomGrid(MiniGridEnv):
    ...
    def place_agent(self, i=None, j=None, rand_dir=True):
        ...
        while True:
            ...
            if front_cell == None or front_cell.type == 'wall':
                break
    ...
    def connect_all(self, door_colors=COLOR_NAMES, max_itrs=5000):
        ...
        while True:
            ...
            door, door_pos = self.add_door(i, j, k, color, False)
            added_doors.append(door)
            added_doors_pos.append(door_pos)

        return added_doors, added_doors_pos
